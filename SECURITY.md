...
The latest 1.1.x release is the currently supported line.
...
siloBrief is not a security scanner or an export-approval system. A path exclusion cannot
identify a sensitive name inside an otherwise allowed file. Generated briefs require complete
human review before they are moved or shared.
